...
/*
   The dialog implementation video-dialog.component.ts implements the
   ModalComponent<VideoDialogContext> interface, required by the modal library.
   Look at how the context (VideoDialogContext) to the dialog is passed to the constructor and how
   we extract and assign the videoId property from the context.
*/
@Component({
